...
/*
	# 배열 (Array)
	  ...
	  - 배열의 인덱스(방 번호)는 0부터 전체 길이 - 1개 있다
 ...
 */
	public static void main(String[] args) {
		...
		System.out.println("세 번째 스캐너: " + scanners[4]);
...
/*
		...
		System.out.println(c); // 변수는 초기화를 해야 된다.
*/		
	...
	//	배열.length를 통해 배열의 전체 길이를 알 수 있다
		System.out.println("randomNums의 길이: " + randomNumbers.length);
		System.out.println("randomNumbers의 마지막 인덱스 번호: "
...
*/
	...
	// String은 char[]로 변환할 수 있다.
		...
		message.charAt(5);		// 값 하나만 꺼냄
		message.toCharArray();	// 값 전체를 꺼냄
