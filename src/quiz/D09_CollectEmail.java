...
*/
	...
	public static void main(String[] args) {
		...
		System.out.println("올바른 email의 갯수");
		...
		for (String overlap : emailList) {
			if (!sortList.contains(overlap)) {
				sortList.add(overlap);
			} else {
				count++;
				System.out.println("중복된 email : " + overlap);
			}
		}
		System.out.println("중복된 email 갯수 : " + count);
	}
}
