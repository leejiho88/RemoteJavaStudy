...
*/
	public static void main(String[] args) {
		...
		*/
		// 참조형은 메모리에 저장할떄 주소형태로, 크기가 일정하지 않아 메모리에 차곡차곡
		// 저장할 수 없다.
		...
		// remove(index) : 해당 번쨰 데이터를 삭제한다. 방금 지운 데이터를 반환한다.
		...
		System.out.println(numbers.remove(new Character('한')));
		**/
	}
